...
public class Test_3_emptyList_addToRearA_A
{
	...
	//****** Constants used in tests *****************
		// Name of class
		private static String CLASS_NAME = "Test_3_emptyList_addToRearA_A"; 
		// Description of change scenario testing 
		private static final String testDescription = 
				"Change Scenario 3: [] -> addToRear(A) -> [A]"; 
		// Number of tests run 
	...
	public void initialize()
	{
		...
		// apply change 
		list.addToRear(IndexedUnsortedListTests.A);
	}
