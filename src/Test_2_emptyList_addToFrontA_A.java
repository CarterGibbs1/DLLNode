...
public class Test_2_emptyList_addToFrontA_A
{
	...
	//****** Constants used in tests *****************
		// Name of class
		private static String CLASS_NAME = "Test_2_emptyList_addToFrontA_A"; 
		// Description of change scenario testing 
		private static final String testDescription = 
				"Change Scenario 2: [] -> addToFront(A) -> [A]"; 
		// Number of tests run 
		private static final int NUM_TESTS = 34; 
	...
	public void initialize()
	{
		...
		// apply change 
		list.addToFront(IndexedUnsortedListTests.A);
	}
