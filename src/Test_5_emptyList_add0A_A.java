...
public class Test_5_emptyList_add0A_A
{
	...
	//****** Constants used in tests *****************
		// Name of class
		private static String CLASS_NAME = "Test_5_emptyList_add0A_A"; 
		// Description of change scenario testing 
		private static final String testDescription = 
				"Change Scenario 5: [] -> add(0,A) -> [A]"; 
		// Number of tests run 
	...
	public void initialize()
	{
		...
		// apply change 
		list.add(0, IndexedUnsortedListTests.A);
	}
